    ...
    public class DataContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //optionsBuilder.UseSqlServer("Server=tcp:misionticronin.database.windows.net,1433;Initial Catalog=Torneo2;Persist Security Info=False;User ID=admin_1;Password=abcd1234*;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;EnableRetryOnFailure");
